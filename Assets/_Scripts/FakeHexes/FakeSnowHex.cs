...
{
    public class FakeSnowHex:BaseFakeHexType
    {
        public FakeSnowHex(Position position, int layer) : base(position, layer)
        {
        }
        ...
        {
            BaseOperationWithMap.ChangeHex(Position,Layer,map,new FakeIceHex(Position,Layer));
        }
